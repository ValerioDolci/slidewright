      ...
      <div class="help__cols">
        <div>
          ...
          <ul>
            ...
            <li><b>⇧-click</b> → aggiungi/togli dalla selezione</li>
            <li><b>⇧-trascina</b> → riquadro: seleziona più box e spostali insieme</li>
  ...
  <main class="workspace">
    ...
    <section class="stage" id="stage" data-reveal>
      ...
      <div class="stage__bar">
        ...
        <span class="stage__warn" id="stage-warn" hidden>⚠ contenuto oltre i bordi (verrà tagliato)</span>
